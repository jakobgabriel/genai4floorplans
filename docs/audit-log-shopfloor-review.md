...
| C-02/04/09/10/11/12/13 | Resource-Parametrik, Testfit, Verteilungen, Snapshots, Portfolio-UI, Pattern-Library | 🔵 offen (Roadmap) | Greenfield-Features; bewusst nicht in dieser Iteration — Umfang je Wochen; Halbausbau widerspräche §4/§5 |
