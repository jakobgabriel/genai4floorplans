...
| C-04/09/10/11/12 | Testfit, Verteilungen, Snapshots, Portfolio-UI, Pattern-Library | 🔵 offen (Roadmap) | Greenfield-Features; Umfang je Wochen; Halbausbau widerspräche §4/§5 |
